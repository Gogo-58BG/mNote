        ...
        <div class="modal-dialog" role="document">
            ...
            <div id="created" class="created">Created: <?php echo date("Y-m-d")?></div>
                ...
                <div class="modal-body">
                    <textarea name="body" class="form-control .col-xs-12 .col-sm-6 .col-lg-8" placeholder="Note"
                        required rows="3" style="min-height: 100px;" readonly></textarea>
                    <input type="datetime" id="datepicker1" class="form-control" placeholder="Expiration" name="expired"
                        readonly>
                </div>
                <!-- Modal footer -->
