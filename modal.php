		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">              
					<textarea name="body" class="form-control .col-xs-12 .col-sm-6 .col-lg-8" placeholder="Note" required rows="3" style="min-height: 100px; background-color: #cfc;"></textarea>
					<div id="created" class="created"><?php echo date("Y-m-d")?></div>
						<input type="datetime" id="datepicker" class="form-control" placeholder="Expiration" name="expired" style="background-color: #cfc;">
					</div>
					<!-- Modal footer -->
